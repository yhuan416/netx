...
typedef int32_t (*netx_start)(netx *self);
typedef int32_t (*netx_stop)(netx *self);

typedef int32_t (*netx_send)(netx *self, const uint8_t *data, uint32_t len);

typedef int32_t (*netx_recv_start)(netx *self);
typedef int32_t (*netx_recv_stop)(netx *self);
...
typedef struct
{
    ...
    netx_recv_start recv_start;
    netx_recv_stop recv_stop;
